...
//  Maze
//
//  Created by 福井彩乃 on 2020/05/10.
//  Copyright © 2020 Fukui Ayanon. All rights reserved.
//

import UIKit
import CoreMotion//加速度センサーに関するものを使うための設定
...
//スタートとゴールを表すUIView
    ...
    var goalView: UIView!
    var wallRectArray = [CGRect]()//wallviewのフレームの情報を入れておく配列
        ...
        for y in 0 ..< maze.count {
            for x in 0..<maze[y].count {
                ...
                case 1://当たるとゲームオーバーになるマス
                    let wallView = createView(x: x, y: y, width:cellWidth, height:
    ...
    func createView(x: Int, y:Int, width: CGFloat, height:CGFloat, offsetX:CGFloat, offsetY:CGFloat) -> UIView{
         ...
         func startAccelerometer(){
             ...
             //画面上からプレイヤーがはみ出しそうだったらposXとYを修正
